            ...
            <div className="min-w-0 flex-1 pb-1 pt-2">
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                {profile.semesterHeadLabel ? (
                  <ProfileBadge label={profile.semesterHeadLabel} icon={<Award className="size-3.5" />} />
                ) : null}
                {profile.isVeteran ? (
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    {primaryRole.periodLabel ? (
                      <p className="text-sm font-light text-black/70">{primaryRole.periodLabel}</p>
                    ) : null}
                  </div>
                </div>
            ...
            <div className="rounded-2xl border border-[#2138a2]/15 bg-[#e1e8fd] p-4">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                ...
                <div className="grid flex-1 gap-3 sm:grid-cols-[auto_1fr]">
                  ...
                  <div>
                    <p className="text-sm font-bold text-black">{primaryEnrollment.universityName}</p>
